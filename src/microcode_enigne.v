module microcode_engine #(
    parameter OP_S = 3,
    parameter MICROADDR_S = 3, // up to 8 micro-steps per opcode
    ...
    integer i;
    initial begin
        // default all microinstructions = END (bit 31 = 1)
        ...
        // Build micro-steps for LOAD (001):
        // step 0: MAR <- operand (set MAR_FROM_OPERAND and MAR_LOAD)
        rom[{3'b001, 3'd0}] = 32'b0_0_000000_0_0_1_1_0_0_0_0_0_0_000_0_0_0; // simplified fields (we will decode important fields below)
        // step 1: MEM_RD
        rom[{3'b001, 3'd1}] = 32'b0_0_000000_0_0_0_0_1_0_0_0_0_0_000_0_0_0;
        // step 2: MDR_LOAD from mem + REG_LOADA from MDR -> END
        rom[{3'b001, 3'd2}] = 32'b1_0_000000_0_0_0_0_0_1_0_0_0_0_000_1_0_0;

        // STORE (010): MAR<-operand; MDR<-regA; MEM_WR
        rom[{3'b010, 3'd0}] = 32'b0_0_000000_0_0_1_1_0_0_0_0_0_000_0_0_0;
        rom[{3'b010, 3'd1}] = 32'b0_0_000000_0_0_0_0_0_1_0_0_0_0_000_1_0_0; // MDR load from bus (we will ensure bus = regA)
        rom[{3'b010, 3'd2}] = 32'b1_0_000000_0_0_0_0_0_0_1_0_0_000_0_1_0;

        // ADD (011): ALU_CALC -> REG_LOADA
    ...
    // decode fields from cur_instr (we pick specific bits intentionally)
    wire instr_end        = cur_instr[31];
    wire instr_pc_load    = cur_instr[22];
    wire instr_pc_inc     = cur_instr[23]; // not actually used in this ROM
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (~running) begin
                ...
                // present current microinstruction outputs
